...
// downloads — so every external link in this UI must go through host.openExternal. Cost a
// founder bug report (2026-08-22): the first terms links shipped as plain <a> and "didn't
// open".
