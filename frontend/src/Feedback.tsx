...
const POPPY_ID = "com.affiliatepoppy.desktop";

/** Where a bug goes — the public issue tracker, mirroring `bugsUrl` in extension.json. */
const BUGS_URL = "https://github.com/leonct74/affiliatepoppy/issues";
...
export function Feedback() {
  ...
  useEffect(() => {
    ...
    el.setAttribute("name", "AffiliatePoppy");
    ...
    <div className="stack">
      <div>
        ...
        <p className="muted" style={{ margin: 0 }}>
          Tell us how AffiliatePoppy is doing. Your rating shows on the AgentsPoppy catalogue, and everything here is
