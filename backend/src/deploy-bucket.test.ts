...
describe("deployBucketName", () => {
  it("is DNS-safe, lowercased, and matches the manifest's affiliatepoppy-deploy-* scope", () => {
    expect(deployBucketName("111122223333", "EU-West-1")).toBe("affiliatepoppy-deploy-111122223333-eu-west-1");
  });
});
